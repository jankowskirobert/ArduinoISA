...
bool Buttons::buttonsPressed[numberOfButtons] = {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false};
bool Buttons::buttonsReleased[numberOfButtons] = {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false};

byte Buttons::previousState1 = 255;
byte Buttons::previousState2 = 255;

byte Buttons::currentState1 = 255;
byte Buttons::currentState2 = 255;
...
bool Buttons::buttonPressed( int id )
{
...
bool Buttons::buttonReleased( int id )
{
  if ( id >= numberOfButtons )
    return false;
...
bool Buttons::buttonState( int id )
{
  if ( id >= numberOfButtons )
    return false;
  else if (id < 8)
